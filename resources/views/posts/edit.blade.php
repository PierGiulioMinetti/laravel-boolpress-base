           ...
           <form action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="path_img">Post image</label>
                     ...
                     {{-- isset è un controllo se non è vuota --}}
                    @isset($post->path_img)
                        <div class="wrap-image">
                            <img width="200px" src="{{asset('storage/' . $post->path_img )}}" alt="{{$post->title}}">
                        </div>
                        <h6>
                            Change:
                        </h6>
                ...
                <div class="form-group">
                    <input class="btn btn-primary" type="submit" value="Update a post">
                </div>
           </form>
        </section>
@endsection